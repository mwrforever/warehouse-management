...
// 出入库汇总查询参数校验：日期闭区间必填、粒度枚举、流水来源类型枚举（仅格式层）
...
class MovementsSummaryRequest extends FormRequest
{
    public function authorize(): bool
    {
        // 权限由路由中间件 permission:report.movements 控制，此处不再重复判断（避免与中间件口径漂移）
        return true;
    }
     ...
     * 倒置区间（date_from > date_to）属业务层校验，保留在控制器走 1601 业务码，不在此拦截。
     *
